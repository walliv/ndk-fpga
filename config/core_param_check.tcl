# core_param_check.tcl: Generates constants to the VHDL package and fills them with
# values specified by TCL variables. Also checks the correctness of the set parameters.
...
# ------------------------------------------------------------------------------
set DMA_RX_PKT_SIZE_MIN 60
set DMA_TX_PKT_SIZE_MIN 60
...
set DMA_RX_PKT_SIZE_MAX 4096
set DMA_TX_PKT_SIZE_MAX 4096
...
if { $DMA_TX_PKT_SIZE_MAX > [expr 2**$DMA_TX_DATA_PTR_W -1] } {
    error "The maximum allowed length of a packet is too large and cannot fit to data buffer:\
            DMA_TX_PKT_SIZE_MAX: $DMA_TX_FRAME_SIZE and DMA_TX_DATA_PTR_W: $DMA_TX_DATA_PTR_W"
}
...
VhdlPkgInt  DMA_RX_PKT_SIZE_MAX    $DMA_RX_PKT_SIZE_MAX
VhdlPkgInt  DMA_TX_PKT_SIZE_MAX    $DMA_TX_PKT_SIZE_MAX
...
VhdlPkgInt  HBM_CHANNELS           $HBM_CHANNELS
