...
class scoreboard #(
    ...
    local model #(USR_MFB_ITEM_WIDTH, PCIE_CQ_MFB_ITEM_WIDTH, CHANNELS, DATA_POINTER_WIDTH, USR_MFB_META_WIDTH,
                  DEVICE)                                                                    m_model;
    ...
    function void connect_phase(uvm_phase phase);
        m_pcie_cq_data_exp.connect(m_model.m_cq_data_analysis_fifo.analysis_export);
        m_pcie_cq_meta_exp.connect(m_model.m_cq_meta_analysis_fifo.analysis_export);
        ...
        m_pkt_drop_exp.connect(m_model.m_discard_comp.m_internal_meta_analysis_fifo.analysis_export);
