...
# System Clock for the rest of the logic (100 MHz) - onboard SYSCLK2 Clock
set_property PACKAGE_PIN BL10 [get_ports "SYSCLK_N"];
set_property PACKAGE_PIN BK10 [get_ports "SYSCLK_P"];
set_property IOSTANDARD  LVDS [get_ports "SYSCLK_*"];
create_clock -period 10       [get_ports {SYSCLK_P}]
