...
set IP_PARAMS_L {IP_GEN_FILES false PCIE_ENDPOINT_MODE 2 IP_BUILD_DIR ../src CORE_BASE ../../../core SDM_SYSMON_ARCH USP_IDCOMP PCIE_MOD_ARCH USP APP_CORE_ARCH MANYCORE CLOCK_GEN_ARCH USP IP_TEMPLATE_ROOT ../../../core/ip VIRTUAL_DEBUG_ENABLE false DMA_TYPE 4 IP_COMP_NAME axi_quad_spi_0 IP_EXT_BASE ../src}
source ${shell_git_root}/cards/alveo-u200/src/axi_quad_spi_0.ip.tcl
set IP_PARAMS_L {IP_GEN_FILES false PCIE_ENDPOINT_MODE 2 IP_BUILD_DIR ../src CORE_BASE ../../../core SDM_SYSMON_ARCH USP_IDCOMP PCIE_MOD_ARCH USP APP_CORE_ARCH MANYCORE CLOCK_GEN_ARCH USP IP_TEMPLATE_ROOT ../../../core/ip VIRTUAL_DEBUG_ENABLE false DMA_TYPE 4 IP_COMP_NAME pcie4_uscale_plus IP_EXT_BASE ../src}
...
read_vhdl -library work -vhdl2008 ${shell_git_root}/core/boot_ctrl/boot_ctrl.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/core/fpga_common.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/apps/application_core_ent.vhd
read_xdc ${shell_git_root}/apps/manycore/pblock_constr.xdc
read_vhdl -library work -vhdl2008 ${shell_git_root}/apps/manycore/application_core_full_arch.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/apps/manycore/barrel_proc_debug_core.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/comp/mem_tools/debug/hbm_tester/hbm_tester.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/comp/mem_tools/debug/hbm_tester/comp/hbm_tester_adc.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/comp/mem_tools/debug/hbm_tester/comp/hbm_tester_port.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/comp/mem_tools/debug/hbm_tester/comp/hbm_tester_mon.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/comp/mem_tools/debug/hbm_tester/comp/hbm_tester_gen.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/comp/base/logic/lfsr_simple_random_gen/lfsr_simple_random_gen.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/core/jtag_op_ctrl/jtag_op_ctrl_empty.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/core/jtag_op_ctrl/jtag_op_ctrl_ent.vhd
...
read_vhdl -library work -vhdl2008 ${shell_git_root}/core/sdm_ctrl/sdm_ctrl_usp_idcomp.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/core/sdm_ctrl/sdm_ctrl_ent.vhd
...
read_vhdl -library work -vhdl2008 ${shell_git_root}/core/clk_gen/clk_gen_usp.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/core/clk_gen/clk_gen_ent.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/core/dma/dma_full_arch.vhd
...
read_vhdl -library work -vhdl2008 ${shell_git_root}/comp/dma/dma_calypte/comp/tx/comp/software_manager/tx_dma_sw_manager.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/comp/dma/dma_calypte/comp/tx/comp/chan_start_stop_ctrl/tx_dma_chan_start_stop_ctrl.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/comp/mfb_tools/flow/dropper/mfb_dropper.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/comp/dma/dma_calypte/comp/rx/comp/hdr_manager/pkg/dma_hdr_pkg.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/comp/dma/dma_calypte/comp/tx/comp/metadata_extractor/tx_dma_metadata_extractor.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/comp/pcie/logic/byte_en_decoder/byte_en_decoder.vhd
...
read_vhdl -library work -vhdl2008 ${shell_git_root}/comp/mfb_tools/logic/speed_meter/mfb_speed_meter_mi.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/comp/mfb_tools/logic/speed_meter/mfb_speed_meter.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/comp/mfb_tools/debug/frame_player/mfb_frame_player.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/comp/mfb_tools/storage/fifo_bram/mfb_fifo_bram.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/comp/base/fifo/fifo_bram/fifo_bram.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/comp/mfb_tools/debug/dma_generator/dma_mfb_generator.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/comp/mfb_tools/debug/generator/mfb_generator_mi32.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/comp/mfb_tools/debug/generator/mfb_generator.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/comp/mfb_tools/debug/generator/mfb_generator_core_pacp.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/comp/mfb_tools/debug/generator/mfb_generator_core.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/comp/base/logic/ones_insertor/ones_insertor.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/comp/base/misc/packet_planner/packet_planner.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/comp/base/misc/deficit_idle_counter/deficit_idle_counter.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/core/pcie/pcie_top.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/core/pcie/comp/pcie_ctrl/pcie_ctrl.vhd
...
read_vhdl -library work -vhdl2008 ${shell_git_root}/core/pcie/comp/pcie_core/pcie_core_usp.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/core/pcie/comp/pcie_core/pcie_core_ent.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/core/pcie/comp/pcie_core/pcie_core_debug.vhd
...
read_vhdl -library work -vhdl2008 ${shell_git_root}/core/pcie/comp/pcie_adapter/pcie_adapter.vhd
...
read_vhdl -library work -vhdl2008 ${shell_git_root}/comp/base/fifo/fifox_multi/fifox_multi_full.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/comp/base/fifo/fifox_multi/fifox_multi_shakedown.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/comp/base/fifo/fifox_multi/fifox_multi_ent.vhd
...
read_vhdl -library work -vhdl2008 ${shell_git_root}/comp/base/logic/barrel_shifter/barrel_bit_rotator.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/comp/base/logic/barrel_shifter/barrel_bit_shifter_ent.vhd
...
read_vhdl -library work -vhdl2008 ${shell_git_root}/core/mi_addr_space_pkg.vhd
read_vhdl -library work -vhdl2008 ${shell_git_root}/core/core_const_pkg.vhd
