...
set_property PACKAGE_PIN BC21    [get_ports {STATUS_LEDS[0]}]
set_property PACKAGE_PIN BB21    [get_ports {STATUS_LEDS[1]}]
# set_property PACKAGE_PIN BA20    [get_ports {STATUS_LEDS[2]}]
