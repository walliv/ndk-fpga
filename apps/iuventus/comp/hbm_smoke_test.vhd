...
architecture FULL of HBM_SMOKE_TEST is
    ...
    -- MI regs (offset=MI_ADDR(6:2)): 0x00 CTRL(WO) bit0=wr,bit1=rd; 0x04 STATUS(RO)
    -- busy/done,[9:8]=BRESP,[11:10]=RRESP; 0x08/0x0C ADDR_L/H(RW) 34b addr; 0x10-4C
    -- WDATA0..7(RW)/RDATA0..7(RO) 256b beat; 0x50 PORT_SEL(RW) idx(0..31).
