...
# No DMA: this design is PCIe, MI and the HBM tester only, so a port measurement is of the port
# alone rather than one shared with traffic the tester cannot see.
set DMA_TYPE 0
