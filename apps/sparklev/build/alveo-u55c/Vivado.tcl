...
# DMA_TYPE must propagate into IP generation: the PCIe IP (pcie4_uscale_plus.ip.tcl)
# enables the 16 GB BAR2 window only when PARAMS(DMA_TYPE) == 6. Without this it
# defaults to a 16 MB BAR2 and the H2C Hyperion HBM windows cannot be mapped.
