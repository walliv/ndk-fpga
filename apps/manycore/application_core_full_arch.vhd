...
architecture FULL of APPLICATION_CORE is
    ...
    constant MI_SPLIT_BASES : slv_array_t(MI_SPLIT_PORTS-1 downto 0)(MI_WIDTH-1 downto 0) := (
        0 => X"00000000",               -- Barrel proc debug core
        1 => X"00100000");              -- HBM tester
    constant MI_SPLIT_ADDR_MASK : std_logic_vector(MI_WIDTH -1 downto 0) := X"00100000";
...
begin
    ...
    mi_splitter_g: if (HBM_CHANNELS > 0) generate
        ...
        mi_split_addr(0) <= sync_mi_addr;
        mi_split_dwr(0)  <= sync_mi_dwr;
        mi_split_be(0)   <= sync_mi_be;
        mi_split_rd(0)   <= sync_mi_rd;
        mi_split_wr(0)   <= sync_mi_wr;
        sync_mi_drd      <= mi_split_drd(0);
        sync_mi_ardy     <= mi_split_ardy(0);
        sync_mi_drdy     <= mi_split_drdy(0);
    end generate;
